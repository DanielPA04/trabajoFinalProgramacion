	...
	private void initialize() {
		...
		tableArtista.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int cod = (int) modelArtista.getValueAt(index, 0);

				txtCodigoArtista.setText(String.valueOf(cod));
				...
				albums = albumDAO.selectAllAlbumsByArtista(cod);
				loadAlbumes(albums);
				txtArtistaAlbum.setText(String.valueOf(cod));
